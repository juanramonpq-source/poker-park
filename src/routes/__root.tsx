...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32.png?v=pentonui" },
      ...
      { rel: "apple-touch-icon", href: "/__grok/icon-180.png?v=pentonui" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/apple-touch-icon.png?v=pentonui" },
      {
        rel: "stylesheet",
